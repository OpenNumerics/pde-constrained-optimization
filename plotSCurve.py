...
def plotSCurve():
    ...
    CR_values_upper = detectAndReplacePeeks(CR_values_upper)
    T_max_values_upper = detectAndReplacePeeks(T_max_values_upper)
    ...
    l1 = ax1.plot(T_in_vals, CR_values, color=color1, label="Conversion")
    ax1.plot(T_in_vals_upper, CR_values_upper, color=color1, label="Conversion")
    ...
    l2 = ax2.plot(T_in_vals, T_max_values, color=color2, label=r"$T_{\max}$")
    ax2.plot(T_in_vals_upper, T_max_values_upper, color=color2, label=r"$T_{\max}$")
